...
public class removeCmd extends AbstractTagAdminCommands {
	int amount;

	public removeCmd(TNTTag plugin) {
		super(plugin, "remove", Messages.getMessage(Message.remove), "<coins|wins|tags|taggeds> <player>", new Permissions().remove, true);
	}
